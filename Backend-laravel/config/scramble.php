...
return [
    ...
    'info' => [
         ...
         * API version.
         */
        'version' => env('API_VERSION', '1.3.2'),

        /*
         * Description rendered on the home page of the API documentation (`/docs/api`).
         */
        'description' => 'API REST del ERP Contable Tenri (Laravel 12, arquitectura DDD por dominios). Autenticacion via token Bearer (Sanctum).',
    ],

    'ui' => [
        'title' => 'ERP Contable Tenri — API',
    ],
     ...
     * ],
     */
    // Documenta automaticamente el Bearer auth: las rutas con middleware auth:sanctum quedan protegidas
    // en el spec; las publicas (login, onboarding) quedan como security: [].
