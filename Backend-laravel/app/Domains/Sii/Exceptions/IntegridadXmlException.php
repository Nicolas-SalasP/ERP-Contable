...
/** HARDENING-1 R2 — se lanza cuando XmlDteIntegrityService no puede recuperar un XML del DTE con integridad verificada (ni desde disco ni desde el backup cifrado en BD). */
