...
class SubirCertificadoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'archivo'  => [
                ...
                'file',
                'extensions:p12,pfx',
                'mimetypes:application/pkcs12,application/x-pkcs12,application/octet-stream,application/x-pfx,application/x-pkcs12-certificates',
                'max:50',
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'archivo.mimetypes'  => 'El archivo debe corresponder a un certificado PKCS#12 valido (.pfx/.p12).',
