...
class DevolucionIntegracionException extends RuntimeException
{
    ...
    /** Perdio la carrera del insert unique(empresa_id, clave) de integracion_devolucion_idempotencias: el caller debe reintentar el mismo POST con el mismo Idempotency-Key para recibir la respuesta ya persistida por quien gano. */
