...
class Dj1837Controller extends Controller
{
    public function __construct(
        private readonly DjEngine      $engine,
        private readonly Dj1837Service $dj1837,
    ) {}
    ...
    public function generar(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'mensaje' => 'DJ 1837 generada correctamente.',
                'data'    => $envio,
            ], 201);
        } catch (DjException $e) {
    ...
    public function validar(Request $request, DjEnvio $djEnvio): JsonResponse
    {
        ...
        try {
            $errores = $this->engine->validar($this->dj1837, $djEnvio);
    ...
    public function confirmarPresentacion(Request $request, DjEnvio $djEnvio): JsonResponse
    {
        ...
        return response()->json([
            'mensaje' => 'DJ 1837 marcada como presentada.',
            'data'    => $djEnvio->fresh(),
        ]);
    }
}
