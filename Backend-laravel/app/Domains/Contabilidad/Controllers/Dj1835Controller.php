...
class Dj1835Controller extends Controller
{
    public function __construct(
        private readonly DjEngine      $engine,
        private readonly Dj1835Service $dj1835,
    ) {}
    ...
    public function generar(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'mensaje' => 'DJ 1835 generada correctamente.',
                'data'    => $envio,
            ], 201);
        } catch (DjException $e) {
    ...
    public function validar(Request $request, DjEnvio $djEnvio): JsonResponse
    {
        ...
        try {
            $errores = $this->engine->validar($this->dj1835, $djEnvio);
    ...
    public function descargar(Request $request, DjEnvio $djEnvio)
    {
        ...
        return Storage::disk($disco)->download($djEnvio->archivo_path, "DJ1835_{$djEnvio->anio}.txt");
    }
    ...
    public function confirmarPresentacion(Request $request, DjEnvio $djEnvio): JsonResponse
    {
        ...
        return response()->json([
            'mensaje' => 'DJ 1835 marcada como presentada.',
            'data'    => $djEnvio->fresh(),
        ]);
    }
}
