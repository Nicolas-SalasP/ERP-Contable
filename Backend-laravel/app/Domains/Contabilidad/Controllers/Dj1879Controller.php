...
class Dj1879Controller extends Controller
{
    public function __construct(
        private readonly DjEngine      $engine,
        private readonly Dj1879Service $dj1879,
    ) {}
    ...
    public function generar(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'mensaje' => 'DJ 1879 generada correctamente.',
                'data'    => $envio,
            ], 201);
        } catch (DjException $e) {
    ...
    public function validar(Request $request, DjEnvio $djEnvio): JsonResponse
    {
        ...
        try {
            $errores = $this->engine->validar($this->dj1879, $djEnvio);
    ...
    public function descargar(Request $request, DjEnvio $djEnvio)
    {
        ...
        $nombreArchivo = "DJ1879_{$djEnvio->anio}.txt";
    ...
    public function confirmarPresentacion(Request $request, DjEnvio $djEnvio): JsonResponse
    {
        ...
        return response()->json([
            'mensaje' => 'DJ 1879 marcada como presentada.',
            'data'    => $djEnvio->fresh(),
        ]);
    }
}
