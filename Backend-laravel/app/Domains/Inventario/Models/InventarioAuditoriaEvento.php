...
class InventarioAuditoriaEvento extends Model
{
    ...
    public const ACCION_EVENTO_INTEGRACION_PROCESADO = 'EVENTO_INTEGRACION_PROCESADO';
    public const ACCION_EVENTO_INTEGRACION_IGNORADO = 'EVENTO_INTEGRACION_IGNORADO';
    public const ACCION_EVENTO_INTEGRACION_ERROR = 'EVENTO_INTEGRACION_ERROR';
    ...
    public static function accionesPermitidas(): array
    {
        return [
            ...
            self::ACCION_EVENTO_INTEGRACION_PROCESADO,
            self::ACCION_EVENTO_INTEGRACION_IGNORADO,
            self::ACCION_EVENTO_INTEGRACION_ERROR,
