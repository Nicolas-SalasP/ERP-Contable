...
class InventarioPickingDetalle extends Model
{
    protected $table = 'inventario_picking_detalles';
    ...
    {
        return $this->hasMany(InventarioPickingAsignacion::class, 'picking_detalle_id');
    }

    public function packingDetalle(): HasOne
    {
        return $this->hasOne(InventarioPackingDetalle::class, 'picking_detalle_id');
    }
    ...
    {
        return round((float) $this->cantidad_asignada - (float) $this->cantidad_pickeada - (float) $this->cantidad_cancelada, 4);
    }
}
