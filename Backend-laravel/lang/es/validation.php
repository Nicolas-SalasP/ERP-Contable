...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Sin este archivo, trans('validation.*') devolvía la clave sin traducir
    | (ej. "validation.required" literal) porque no existía NINGUNA carpeta
    | lang/ en el proyecto -- afectaba a cualquier error de validación que
    | llegara al manejador de excepciones por defecto de Laravel sin pasar
    | por un catch(ValidationException) manual con mensaje propio.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute ingresado ha aparecido en una filtración de datos. Elija un :attribute diferente.',
    ],
