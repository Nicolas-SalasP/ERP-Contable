...
class ActivoFijoParametrosTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->usuario = User::create(['nombre' => 'Parametrizador', 'email' => 'param@erp.cl', 'password' => bcrypt('123'), 'empresa_id' => $this->empresa->id, 'rol_id' => $rol->id, 'estado_suscripcion_id' => 1]);
    }
