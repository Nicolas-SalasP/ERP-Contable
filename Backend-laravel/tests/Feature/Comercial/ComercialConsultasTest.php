...
class ComercialConsultasTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->usuario = User::create(['nombre' => 'Admin', 'email' => 'admin@cons.cl', 'password' => bcrypt('123'), 'empresa_id' => $this->empresa->id, 'rol_id' => $this->rolSuperAdmin->id, 'estado_suscripcion_id' => $this->estadoSuscripcionActiva->id]);
    }
