...
class ComercialCicloDeVidaTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->usuario = User::create(['nombre' => 'Vendedor', 'email' => 'v@ciclo.cl', 'password' => bcrypt('123'), 'empresa_id' => $this->empresa->id, 'rol_id' => $this->rolSuperAdmin->id, 'estado_suscripcion_id' => $this->estadoSuscripcionActiva->id]);
    }
