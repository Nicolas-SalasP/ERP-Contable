        ...
        return (
            <div data-testid="error-boundary" className="min-h-[50vh] flex flex-col items-center justify-center p-8 text-center">
                <div className="bg-red-50 border border-red-200 rounded-2xl p-8 max-w-md shadow-sm">
                    ...
                    <h2 className="text-xl font-black text-slate-800 dark:text-slate-200 mb-2">Algo salió mal</h2>
                    ...
                    <div className="flex flex-col gap-2 items-center">
                        ...
                        <button
                            ...
                            className="text-sm text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 underline bg-transparent border-0 cursor-pointer"
                        >
                            Recargar página
                        </button>
                    </div>
