    ...
    return (
        <div className="max-w-5xl mx-auto p-6 md:p-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 mb-6">
                <h2 className="text-sm font-bold text-slate-700 mb-3 uppercase tracking-wide">Generar DJ 1887</h2>
                <div className="flex flex-wrap items-end gap-3">
                    ...
                    <div>
                        <label className="block text-xs font-semibold text-slate-600 mb-1">Año inicio 40h (Ley 21.561)</label>
                        <select
                            value={anio40Horas}
            ...
            {envioActivo ? (
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 mb-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4 text-sm">
                        ...
                        <div className="bg-slate-50 rounded-lg p-3">
                            <div className="text-xs text-slate-500 mb-1">Año 40h</div>
                            <div className="font-bold text-slate-900">{envioActivo.anio_40_horas ?? '—'}</div>
                        </div>
                        <div className="bg-slate-50 rounded-lg p-3">
