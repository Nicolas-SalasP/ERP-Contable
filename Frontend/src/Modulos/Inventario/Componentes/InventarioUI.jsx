...
const toneMap = {
    ...
    PARCIALMENTE_LIBERADA: 'bg-cyan-50 text-cyan-700 border-cyan-200',
    ...
    ajuste_positivo: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    ajuste_negativo: 'bg-orange-50 text-orange-700 border-orange-200',

    ok: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    bajo_minimo: 'bg-amber-50 text-amber-700 border-amber-200',
    ...
    sin_vencimiento: 'bg-slate-100 text-slate-600 border-slate-200',
    valor_cero_o_inconsistente: 'bg-rose-50 text-rose-700 border-rose-200',
