  ...
  return (
    <div className="space-y-4 max-w-4xl mx-auto">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <h1 className="text-xl font-semibold text-slate-800 flex-wrap">Soporte</h1>
        <button
          onClick={abrirCrear}
      ...
      <div className="flex gap-2 flex-wrap">
        <select
          ...
          className="text-base md:text-sm border border-slate-300 rounded-lg px-3 py-2 bg-white"
        >
      ...
      {cargando ? (
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-8 text-center">
          <p className="text-slate-500 text-sm">No hay tickets de soporte.</p>
          <button
            onClick={abrirCrear}
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg">
            <div className="p-5 border-b border-slate-100 flex items-center justify-between">
              ...
              <button
                ...
                className="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-slate-600 text-xl rounded-lg hover:bg-slate-100"
              >
                &times;
              </button>
            </div>
            <form onSubmit={crear} className="p-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-300 rounded-lg px-3 py-2 text-base md:text-sm"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-slate-300 rounded-lg px-3 py-2 text-base md:text-sm bg-white"
                  >
              ...
              <div>
                <label className="block text-xs font-medium text-slate-600 mb-1">Descripcion del problema</label>
                <textarea
                  required
                  rows={5}
                  value={form.message}
              ...
              <div className="flex justify-end gap-2">
                <button
                  type="button"
                  onClick={() => setMostrarCrear(false)}
                  className="text-sm px-4 py-2.5 border border-slate-300 rounded-lg text-slate-600 hover:bg-slate-50"
                >
                  Cancelar
                </button>
                <button
