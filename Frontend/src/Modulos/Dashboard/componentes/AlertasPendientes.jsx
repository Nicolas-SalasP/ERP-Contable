    ...
    return (
        <div className="mb-8">
            ...
            <div className="flex items-center gap-3 mb-4">
                <h3 className="text-base font-bold text-slate-700 whitespace-nowrap flex items-center gap-2">
            ...
            <div className="flex flex-wrap gap-3">
                {alertas.map((alerta, idx) => {
                    ...
                    return (
                        <div
                            key={idx}
                            className={`bg-white rounded-xl border border-gray-100 border-l-4 ${estilos.borde} shadow-sm p-4 flex items-start gap-3 min-w-[240px] max-w-[320px] flex-1`}
                        >
