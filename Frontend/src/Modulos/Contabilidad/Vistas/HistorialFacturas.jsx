    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-6 font-sans text-slate-800 dark:text-slate-200 pb-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                {vistaActual !== 3 && (
                    <div className="flex items-center w-full md:w-auto bg-white dark:bg-slate-800 p-1.5 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
                        <button
                            onClick={() => setVistaActual(1)}
                            className={`flex-1 md:flex-none px-4 py-2 rounded-md text-sm font-bold transition-all ${vistaActual === 1 ? 'bg-slate-900 text-white shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700'}`}
                        >
                            <i className="fas fa-list mr-2"></i> Detallada
                        </button>
                        <button
                            onClick={() => setVistaActual(2)}
                            className={`flex-1 md:flex-none px-4 py-2 rounded-md text-sm font-bold transition-all ${vistaActual === 2 ? 'bg-slate-900 text-white shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700'}`}
                        >
            ...
            {vistaActual !== 3 ? (
                <>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-visible flex flex-col">
                            ...
                            <>
                                <div className="grid grid-cols-1 gap-4 p-4 md:hidden">
                                    {facturas.map((fac) => {
                                        ...
                                        return (
                                            <div key={fac.id} className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 shadow-sm relative">
                                                ...
                                                <div className="pl-2 mb-4">
                                                    ...
                                                    {vistaActual === 1 ? (
                                                        ...
                                                        <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-900 p-2.5 rounded-lg border border-slate-100 dark:border-slate-800">
                                                            ...
                                                            <div className="text-center border-l border-r border-slate-200 dark:border-slate-700 px-3">
                                                ...
                                                <div className="flex flex-col gap-2 pt-3 border-t border-slate-100 dark:border-slate-700 pl-2">
                                                    ...
                                                    <div className={`grid ${(!isNotaCredito && fac.estado === 'REGISTRADA') ? 'grid-cols-2' : 'grid-cols-3'} gap-2`}>
                                                        <button onClick={() => verAsientoContable(fac.id)} className="bg-slate-50 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-600 font-bold text-xs py-2.5 rounded-lg transition-colors border border-slate-200 dark:border-slate-600 flex items-center justify-center gap-1.5">
                                            ...
                                            {facturas.map((fac) => {
                                                ...
                                                return (
                                                    <tr key={fac.id} className="hover:bg-blue-50/30 transition-colors group">
                                                        ...
                                                        {vistaActual === 1 ? (
                                                            <>
                                                                <td className="px-6 py-4 whitespace-nowrap text-slate-600 dark:text-slate-400 font-mono text-xs">{formatDate(fac.fecha_emision)}</td>
                                                                <td className="px-6 py-4">
                                                                    <div className="font-bold text-slate-800 dark:text-slate-200">{fac.proveedor?.razon_social || 'Proveedor Desconocido'}</div>
                                                                    ...
                                                                    <ul className="text-sm font-medium text-slate-700 dark:text-slate-300 py-1">
                                                                        {fac.estado === 'REGISTRADA' && !isNotaCredito && (
                                                                            <li>
                                                                                <button
                                                                                    ...
                                                                                    className="w-full text-left px-4 py-2.5 hover:bg-emerald-50 hover:text-emerald-700 transition-colors flex items-center gap-3 font-bold text-emerald-600 border-b border-slate-100 dark:border-slate-700"
                                                                                >
                                                                                    <CircleDollarSign size={16} strokeWidth={1.75} />
                                                                                    Pagar Documento
                                                                                </button>
                                                                        ...
                                                                        <li>
                                                                            <button
                                                                                ...
                                                                                className="w-full text-left px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-blue-600 transition-colors flex items-center gap-3"
                                                                            >
                                                                        ...
                                                                        {fac.estado !== 'ANULADA' && (
                                                                            <li>
                                                                                <button
                                                                                    ...
                                                                                    className="w-full text-left px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-amber-600 transition-colors flex items-center gap-3"
                                                                                >
                                                                        ...
                                                                        <li>
                                                                            <button
                                                                                ...
                                                                                className="w-full text-left px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-emerald-600 transition-colors flex items-center gap-3 border-t border-slate-100 dark:border-slate-700"
                                                                            >
                        ...
                        {pagination.totalPages > 1 && (
                            <div className="bg-slate-50 dark:bg-slate-900 px-6 py-4 border-t border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row items-center justify-between gap-4 mt-auto rounded-b-xl">
                                <button
                                    disabled={pagination.page === 1}
                                    onClick={() => setPagination(prev => ({ ...prev, page: prev.page - 1 }))}
                                    className="w-full sm:w-auto px-4 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 disabled:opacity-50 transition-colors shadow-sm flex items-center justify-center gap-2"
                                >
                                    <ChevronLeft size={16} strokeWidth={1.75} /> Anterior
                                </button>
                                <span className="text-sm font-medium text-slate-500">Página <span className="font-bold text-slate-800 dark:text-slate-200">{pagination.page}</span> de {pagination.totalPages}</span>
                                <button
