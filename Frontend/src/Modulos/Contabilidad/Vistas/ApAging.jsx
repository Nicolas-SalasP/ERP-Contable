    ...
    useEffect(() => {
        const cargar = async () => {
            ...
            try {
                ...
                logger.error('Error cargando AP Aging', err);
                setError(true);
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="text-xs divide-y divide-slate-100 dark:divide-slate-700">
                            {cargando ? (
                                ...
                                <EstadoVacio mensaje="No hay saldos pendientes con proveedores." />
                            ) : (
                                detalle.map((fila, idx) => (
                                    <tr key={fila.proveedor_id ?? idx} className="hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
